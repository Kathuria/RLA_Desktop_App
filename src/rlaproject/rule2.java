 ...
 * @author Avi Kathuria
 */
public class rule2 extends javax.swing.JFrame {

    /**
     * Creates new form rule2
     */
    public rule2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        back.setBounds(390, 610, 70, 20);
        jLayeredPane1.add(back, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rlaproject/rla_images/rule2.jpg"))); // NOI18N
        jLabel1.setBounds(0, 0, 480, 650);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rule2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
