 ...
 * @author Avi Kathuria
 */
public class rule5 extends javax.swing.JFrame {

    /**
     * Creates new form rule5
     */
    public rule5() {
        initComponents();
    ...
    private void initComponents() {
        ...
        back.setBounds(500, 630, 70, 20);
        jLayeredPane1.add(back, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rlaproject/rla_images/rule5.jpg"))); // NOI18N
        jLabel1.setBounds(0, 0, 580, 660);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rule5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
